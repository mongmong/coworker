...
**Date:** 2026-04-21
**Status:** Applied addendum / historical rationale
**Applies to:** `docs/specs/000-coworker-runtime-design.md`, `docs/specs/001-plan-manifest.md`
**Purpose:** Historical record of clarifications identified during spec review. Most amendments in this file have been incorporated into `000-coworker-runtime-design.md` and `001-plan-manifest.md`; those files are now the normative source of truth.
...
The main ambiguities this addendum resolved were:
...
This file should not be treated as a second active spec. If it conflicts with `000` or `001`, prefer the newer text in those files and update this addendum only to preserve review history.
