# coworker-role-reviewer (OpenCode)
...
Each `opencode serve` instance binds to its own worktree root. File reads
during review are automatically scoped to the dispatched worktree.
